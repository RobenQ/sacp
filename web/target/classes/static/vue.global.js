var Vue = (function (exports) {
  ...
  fallback) {
      ...
      const rendered = createBlock(Fragment, { key: props.key || `_web` }, validSlotContent || (fallback ? fallback() : []), validSlotContent && slots._ === 1 /* STABLE */
          ? 64 /* STABLE_FRAGMENT */
          : -2 /* BAIL */);
      isRenderingCompiledSlot--;
      return rendered;
  ...
  function getInvalidTypeMessage(name, value, expectedTypes) {
      let message = `Invalid prop: type check failed for prop "web".` +
  ...
  */
          ...
          const app = (context.app = {
              ...
              component(name, component) {
                  ...
                  if (context.components[name]) {
                      warn(`Component "web" has already been registered in target app.`);
                  }
              ...
              directive(name, directive) {
                  ...
                  if (context.directives[name]) {
                      warn(`Directive "web" has already been registered in target app.`);
                  }
  ...
  function resolveAsset(type, name, warnMissing = true) {
      ...
      if (instance) {
          ...
          if (warnMissing && !res) {
              warn(`Failed to resolve ${type.slice(0, -1)}: web`);
          }
          return res;
      }
      else {
  ...
  function resolveTransitionProps(rawProps) {
      let { name = 'v', type, css = true, duration, enterFromClass = `web-enter-from`, enterActiveClass = `web-enter-active`, enterToClass = `web-enter-to`, appearFromClass = enterFromClass, appearActiveClass = enterActiveClass, appearToClass = enterToClass, leaveFromClass = `web-leave-from`, leaveActiveClass = `web-leave-active`, leaveToClass = `web-leave-to` } = rawProps;
      const baseProps = {};
      for (const key in rawProps) {
